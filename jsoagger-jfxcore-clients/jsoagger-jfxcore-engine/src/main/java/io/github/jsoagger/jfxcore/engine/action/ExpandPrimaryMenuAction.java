 ...
 * @date 2019
 */
public class ExpandPrimaryMenuAction extends AbstractAction implements IAction {

  /**
   * Constructor
   */
  public ExpandPrimaryMenuAction() {
    super();
  }
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    DisplayMenuEvent displayMenuEvent = new DisplayMenuEvent(MenuPos.PRIMARY_MENU);
