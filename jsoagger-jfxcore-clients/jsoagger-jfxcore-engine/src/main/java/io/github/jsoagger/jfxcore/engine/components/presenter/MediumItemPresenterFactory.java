 ...
 * @date 2019
 */
public class MediumItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable, IIDentifiable {
   ...
   * Constructor
   */
  public MediumItemPresenterFactory() {
    URL location = MediumItemPresenterFactory.class.getResource("MediumItemPresenterFactory.fxml");
