 ...
 * @date 15 mars 2018
 */
public class ErrorDialog extends VLDialog {
  ...
  public static class Builder {
    ...
    public ErrorDialog build(AbstractViewController controller) {
      final ErrorDialog dialog = (ErrorDialog) Services.getBean("ErrorDialog");
  ...
  private static VLViewComponentXML getPrimaryDialogConfig() {
    return Services.getDialogConfig("primaryErrorDialog.xml");
  }


  private static VLViewComponentXML getAccentDialogConfig() {
    return Services.getDialogConfig("accentErrorDialog.xml");
  }
