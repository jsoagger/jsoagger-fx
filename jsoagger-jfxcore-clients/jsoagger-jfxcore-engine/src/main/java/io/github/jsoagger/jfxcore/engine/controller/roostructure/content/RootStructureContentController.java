...
public class RootStructureContentController extends AbstractViewController {
  ...
  protected void process() {
    ...
    layout.setStyle("-fx-background-color:-background-color");
  ...
  public synchronized <T extends GenericEvent> void handle(T e) {
    super.handle(e);
    if (e.isA(CoreEvent.PushStructureContentEvent)) {
  ...
  public void setProcessing() {
    ...
    layout.getChildren().add(NodeHelper.getProcessingIndicator());
  }
