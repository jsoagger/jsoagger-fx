 ...
 *
 */
public class NotImplementedAction extends AbstractAction implements IAction {
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    new InformationDialog.Builder().title("Not implemented").message("This function is not implemented").buildPrimary(controller).show();
  }
