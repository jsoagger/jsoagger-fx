...
public class WrappedInput implements IBuildable {
   ...
   */
  @Override
  public void buildFrom(IJSoaggerController controller, VLViewComponentXML attributeCfg) {
    component = new InputComponentWrapper();
    component.buildFrom(attributeCfg, (AbstractViewController) controller, InputMode.EDIT, true);
  }
}
