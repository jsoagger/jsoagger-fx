 ...
 * @date 30 janv. 2018
 */
public class ModelMasterDescriptionPresenter extends ModelDescriptionPresenter {

  /**
   * Default Constructor
   */
  public ModelMasterDescriptionPresenter() {
    super();
  }
  ...
  protected String getAttributeName(IJSoaggerController controller, VLViewComponentXML configuration) {
    return "masterAttributes.description";
  }
}
