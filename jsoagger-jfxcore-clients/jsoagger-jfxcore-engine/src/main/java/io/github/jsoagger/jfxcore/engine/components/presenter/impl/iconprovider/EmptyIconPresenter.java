 ...
 * @date 29 janv. 2018
 */
public class EmptyIconPresenter extends CellPresenterImpl implements ModelIconPresenter {

  /**
   * Default Constructor
   */
  public EmptyIconPresenter() {}
  ...
  public Node provideIcon(IJSoaggerController controller, VLViewComponentXML configuration, Object forModel) {
    return provideIcon(controller, configuration);
  }
