 ...
 *
 */
public class PrintSelectedElementsInTableStructureAction extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public PrintSelectedElementsInTableStructureAction() {
    super();
  }
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    new InformationDialog.Builder().title("Print").message("This function is not implemented").buildPrimary(controller).show();
  }
