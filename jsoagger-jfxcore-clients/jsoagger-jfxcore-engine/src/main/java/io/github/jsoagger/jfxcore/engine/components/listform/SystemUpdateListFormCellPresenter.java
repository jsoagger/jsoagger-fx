 ...
 */
public class SystemUpdateListFormCellPresenter extends PreferenceItemPresenterFactory implements IListFormCellPresenter {
  ...
  /**
   */
  public SystemUpdateListFormCellPresenter() {
  ...
  public void buildFrom(IJSoaggerController controller, VLViewComponentXML configuration) {
    ...
    valueLabel.setText("No update avalaible");
