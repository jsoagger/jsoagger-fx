...
public interface IListFormDataLoader {
  ...
  Node getDisplayNode(List<IListFormValue> values);

  default String getDisplayText(List<IListFormValue> values) {
    return "";
  }
  ...
  void setPresenter(PreferenceItemPresenterFactory presenter);


  void setCurrentValue(List<IListFormValue> selected);
}
