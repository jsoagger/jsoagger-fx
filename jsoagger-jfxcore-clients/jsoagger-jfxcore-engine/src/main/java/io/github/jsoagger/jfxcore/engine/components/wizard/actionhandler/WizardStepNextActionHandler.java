...
/**
 * Handle workflow when user clicks on next button.
 *
 * @author Ramilafananana VONJISOA
 * @mailto yvonjisoa@nexitia.com
 * @date 2019
 */
public class WizardStepNextActionHandler extends WizardStepActionHandler implements IActionHandler {

  //private static final Logger logR = LoggerFactory.getLogger(WizardStepNextActionHandler.class);
