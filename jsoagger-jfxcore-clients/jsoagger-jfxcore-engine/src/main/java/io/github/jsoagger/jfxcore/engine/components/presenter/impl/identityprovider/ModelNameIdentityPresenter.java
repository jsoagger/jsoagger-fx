 ...
 * @date 30 janv. 2018
 */
public class ModelNameIdentityPresenter extends AbstractModelPresenter implements ModelIdentityPresenter {

  /**
   * Default Constructor
   */
  public ModelNameIdentityPresenter() {
    super();
  }
  ...
  public String identityOf(IJSoaggerController controller, VLViewComponentXML component) {
    return getModelAttribute(controller, "attributes.name");
  }
  ...
  public String identityOf(IJSoaggerController controller, VLViewComponentXML configuration, Object forModel) {
    return getModelAttribute((OperationData) forModel, "attributes.name");
  }
