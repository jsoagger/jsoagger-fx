...
import io.github.jsoagger.jfxcore.engine.utils.ReflectionUIUtils;import javafx.collections.FXCollections;
...
public class NavigableListView extends FixedSizeListView<IListFormCellPresenter> {
  ...
  protected Skin createDefaultSkin() {
	  ...
	  Skin skin =  (Skin) ReflectionUIUtils.newInstance("io.github.jsoagger.jfxcore.engine.components.list.utils.FixedSizeListViewSkin", argsValues, ListView.class);
    //skin.setScrollableVertically(false);
	  return skin;
  }
}
