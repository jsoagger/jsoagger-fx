...
public class RemoveUsageLinkWithoutWizardActionPresenter extends ViewActionPresenter implements IBuildable {
   ...
   * Default Constructor
   */
  public RemoveUsageLinkWithoutWizardActionPresenter() {}
  ...
  public void doAction() {
    ...
    // model.addProperty("linkType",
    // "io.github.jsoagger.objectLink.PartLink/PartUsageLink");

    operation.doOperation(model, this::deleteSuccess, this::onActionGeneralError);
  }


  protected void deleteSuccess(IOperationResult operationResult) {
    if (!operationResult.hasBusinessError()) {
      ...
      LinkDeletedEvent event = new LinkDeletedEvent();
