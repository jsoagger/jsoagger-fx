...
/**
 * Tab used in the listViewPaneHeader section of the application.
 *
...
public class HeaderTab extends VBox {
  ...
  /** CSS */
  private final static String HEADER_TAB_ITEM_CONTAINER = "listViewPaneHeader-tab-item-container";
  private final static String HEADER_TAB_ITEM_TITLE = "listViewPaneHeader-tab-item-title";
   ...
   * @param text
   */
  public HeaderTab(VLViewComponentXML config, String text) {
    this.config = config;
   ...
   * @param content
   */
  public HeaderTab(VLViewComponentXML config, String text, Node content) {
    this(config, text);
  ...
  public boolean equals(Object obj) {
    ...
    final HeaderTab other = (HeaderTab) obj;
    if (title == null) {
      if (other.title != null) {
        return false;
      }
