...
/**
 * Select all or deselect all checkboxes on the table.
 *
...
public class SelectAllElementsInTableStructureAction extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public SelectAllElementsInTableStructureAction() {}
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    boolean allSelected = table.isAllRowsSelected();
    table.selectCheckboxes(!allSelected);
  }
