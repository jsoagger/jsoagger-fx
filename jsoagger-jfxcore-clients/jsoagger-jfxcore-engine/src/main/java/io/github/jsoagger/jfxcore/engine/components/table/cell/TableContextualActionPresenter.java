 ...
 * @date 13 févr. 2018
 */
public class TableContextualActionPresenter extends CellPresenterImpl {
   ...
   * Default Constructor
   */
  public TableContextualActionPresenter() {
    super();
  }
  ...
  public Node present(IJSoaggerController controller, VLViewComponentXML configuration, Object item) {
    IconUtils.setFontIcon("fa-sitemap:18", action);
    action.getStyleClass().addAll("ep-table-forward-to-structure-actions");
    action.getGraphic().getStyleClass().addAll("grey-flat-ikonli");
