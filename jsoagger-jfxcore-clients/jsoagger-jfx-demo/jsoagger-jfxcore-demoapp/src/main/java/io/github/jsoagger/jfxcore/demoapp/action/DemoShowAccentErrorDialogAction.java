 ...
 *
 */
public class DemoShowAccentErrorDialogAction extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public DemoShowAccentErrorDialogAction() {
    super();
  }
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    new ErrorDialog.Builder().title("Error").message("Error handling sample.").buildAccent(controller).show();
  }
