 ...
 *
 */
public class RefreshButtonDemoAction extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public RefreshButtonDemoAction() {
    super();
  }
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    new InformationDialog.Builder().title("Welcome").message("Hi, welcome to JSoagger  :-!").buildAccent(controller).show();
  }
  ...
  @Override
  public String getId() {
    return "RefreshButtonDemoAction";
  }
}
