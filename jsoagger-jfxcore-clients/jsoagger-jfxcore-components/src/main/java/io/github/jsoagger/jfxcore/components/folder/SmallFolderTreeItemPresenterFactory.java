 ...
 * @date 2019
 */
public class SmallFolderTreeItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public SmallFolderTreeItemPresenterFactory() {
    URL location = SmallFolderTreeItemPresenterFactory.class.getResource("SmallFolderTreeItemPresenterFactory.fxml");
