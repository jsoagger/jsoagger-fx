 ...
 * @date 2019
 */
public class MediumStructureItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public MediumStructureItemPresenterFactory() {
    URL location = MediumStructureItemPresenterFactory.class.getResource("MediumStructureItemPresenterFactory.fxml");
