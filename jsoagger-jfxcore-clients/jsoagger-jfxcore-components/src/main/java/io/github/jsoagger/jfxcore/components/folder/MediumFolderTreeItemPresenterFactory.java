 ...
 * @date 2019
 */
public class MediumFolderTreeItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public MediumFolderTreeItemPresenterFactory() {
    URL location = MediumFolderTreeItemPresenterFactory.class.getResource("MediumFolderTreeItemPresenterFactory.fxml");
