...
/**
 * Return a search result view identifier according to a type and a context.
 *
 * @author Ramilafananana  VONJISOA
 *
 */
public class SearchAllTypesResultViewResolver implements IViewResolver {
   ...
   * Constructor
   */
  public SearchAllTypesResultViewResolver() {}
