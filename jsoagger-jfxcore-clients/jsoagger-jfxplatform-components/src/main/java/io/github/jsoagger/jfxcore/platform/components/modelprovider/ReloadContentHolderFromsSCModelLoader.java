...
public class ReloadContentHolderFromsSCModelLoader implements IModelProvider {

  /**
   * Constrcutor
   */
  public ReloadContentHolderFromsSCModelLoader() {}
  ...
  public IOperationResult loadModel(IJSoaggerController controller, String componentId) {
    final IOperation operation = (IOperation) Services.getBean("PersistableLoadBasicContentHolderModelOperation");
    final OperationData operationData = ((AbstractViewController) controller).getStructureContent().getFormModelData();

    final JsonObject query = new JsonObject();
    final String fullId = (String) operationData.getAttributes().get("fullId");
