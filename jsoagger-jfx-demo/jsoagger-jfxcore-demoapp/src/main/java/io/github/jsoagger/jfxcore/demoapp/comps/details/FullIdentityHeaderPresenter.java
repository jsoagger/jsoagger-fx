 ...
 * @date 4 févr. 2018
 */
public class FullIdentityHeaderPresenter extends AbstractModelPresenter implements ModelHeaderIdentityPresenter {

  /**
   * Default Constructor
   */
  public FullIdentityHeaderPresenter() {}
  ...
  public String identityOf(IJSoaggerController controller, VLViewComponentXML configuration, Object forModel) {
    ...
    final String firstName = data.getAttributes().get("model") == null ? "" : (String) data.getAttributes().get("model");
    final String lastName = data.getAttributes().get("yearmodel") == null ? "" : (String) data.getAttributes().get("yearmodel");
