 ...
 *
 */
public class ExportButtonDemoAction extends AbstractAction implements IAction {
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    new InformationDialog.Builder().title("Export").message("Export function is not implemented").buildPrimary(controller).show();
  }
