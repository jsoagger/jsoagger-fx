...
public class DemoAppDesktopViewStructureBeansProvider {
  ...
  public Properties platformProperties() {
    ...
    platformProperties.setProperty("applicationWindowName", "JSOAGGER DEMO APPLICATION");
    platformProperties.setProperty("applicationTitle", "JSOAGGER DEMO APPLICATION");
