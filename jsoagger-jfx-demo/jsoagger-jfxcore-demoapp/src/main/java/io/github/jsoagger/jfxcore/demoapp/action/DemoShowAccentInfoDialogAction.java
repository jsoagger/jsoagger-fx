 ...
 *
 */
public class DemoShowAccentInfoDialogAction extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public DemoShowAccentInfoDialogAction() {
    super();
  }
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    new InformationDialog.Builder().title("Information")
    .message("This is a dialog with accent color.").buildAccent(controller).show(true);
  }
