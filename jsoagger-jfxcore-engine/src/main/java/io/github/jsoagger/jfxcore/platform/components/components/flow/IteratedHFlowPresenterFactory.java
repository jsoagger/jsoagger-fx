 ...
 * @date 2019
 */
public class IteratedHFlowPresenterFactory extends MultiPresenterFactory implements IIDentifiable, IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public IteratedHFlowPresenterFactory() {
    NodeHelper.loadFXML(getLocation(), this);
  }


  protected URL getLocation() {
    return IteratedHFlowPresenterFactory.class.getResource("IteratedHFlowItem.fxml");
  }
