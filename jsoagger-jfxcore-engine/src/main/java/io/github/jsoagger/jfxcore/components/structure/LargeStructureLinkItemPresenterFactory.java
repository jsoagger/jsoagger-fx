 ...
 * @date 2019
 */
public class LargeStructureLinkItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public LargeStructureLinkItemPresenterFactory() {
    URL location = SmallStructureItemPresenterFactory.class.getResource("LargeStructureLinkItemPresenterFactory.fxml");
