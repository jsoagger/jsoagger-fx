 ...
 * @date 2019
 */
public class SmallStructureItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public SmallStructureItemPresenterFactory() {
    URL location = SmallStructureItemPresenterFactory.class.getResource("SmallStructureItemPresenterFactory.fxml");
