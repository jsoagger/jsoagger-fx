 ...
 * @date 2019
 */
public class FolderLargeFlowItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public FolderLargeFlowItemPresenterFactory() {
    URL location = FolderLargeFlowItemPresenterFactory.class.getResource("FolderLargeFlowItemPresenterFactory.fxml");
  ...
  public void buildFrom(IJSoaggerController controller, VLViewComponentXML configuration) {
    ...
    if (identityPresenter != null) {
      ...
      cell.addEventFilter(MouseEvent.MOUSE_CLICKED, e -> loadContent(e));
    }
    ...
    IconUtils.setFontIcon("fa-angle-right:30", loadChildrenLabel);
    loadChildrenLabel.addEventFilter(ActionEvent.ACTION, e -> loadChidren(e));

    // click on each cell
    rootContainer.addEventFilter(MouseEvent.MOUSE_CLICKED, e -> loadContent(e));
    rootContainer.addEventFilter(TouchEvent.TOUCH_RELEASED, e -> loadContent(e));
  }
