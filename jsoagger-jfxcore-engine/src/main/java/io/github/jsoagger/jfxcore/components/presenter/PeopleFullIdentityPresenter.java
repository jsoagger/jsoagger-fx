 ...
 *
 */
public class PeopleFullIdentityPresenter extends AbstractModelPresenter implements ModelIdentityPresenter {

  /**
   * Default Constructor
   */
  public PeopleFullIdentityPresenter() {}
  ...
  public String identityOf(IJSoaggerController controller, VLViewComponentXML configuration, Object forModel) {
    ...
    final String firstName = (String) model.getAttributes().get("firstName");
    final String lastName = (String) model.getAttributes().get("lastName");
