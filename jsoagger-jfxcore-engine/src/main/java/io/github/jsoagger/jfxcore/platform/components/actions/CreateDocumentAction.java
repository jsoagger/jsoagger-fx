 ...
 *
 */
public class CreateDocumentAction extends AbstractAction implements IAction {

  private IOperation createDocumentOperation;//  needs createDocumentOperation
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    createDocumentOperation.doOperation(query, this::createSuccess, this::onActionGeneralError);
  }
  ...
  /**
   * @return the createDocumentOperation
   */
  public IOperation getCreateDocumentOperation() {
    return createDocumentOperation;
  }


  /**
   * @param createDocumentOperation the createDocumentOperation to set
   */
  public void setCreateDocumentOperation(IOperation createDocumentOperation) {
    this.createDocumentOperation = createDocumentOperation;
  }
}
