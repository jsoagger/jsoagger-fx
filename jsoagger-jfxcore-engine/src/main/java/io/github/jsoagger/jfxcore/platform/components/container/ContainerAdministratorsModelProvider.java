 ...
 * @date 2019
 */
public class ContainerAdministratorsModelProvider implements IModelProvider {

  private IOperation loadContainerAdminOperation; // needs LoadContainerAdministratorsOperation
  ...
  public IOperationResult loadModel(IJSoaggerController controller, String compId) {
    ...
    loadContainerAdminOperation.doOperation(query, operationResult -> {
