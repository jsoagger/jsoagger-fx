 ...
 *
 */
public class ModelByMasterOidDoActionAndForwardToViewHandler extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public ModelByMasterOidDoActionAndForwardToViewHandler() {}
  ...
  public void execute(IActionRequest actionRequest, Optional<IActionResult> previousActionResult) {
    ...
    this.replacePreviousView = Boolean.valueOf((String)actionRequest.getProperty("replace"));
