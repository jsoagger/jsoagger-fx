...
public class QuaternaryMenuController extends StandardViewController {
   ...
   * Constructor
   */
  public QuaternaryMenuController() {
    super();
  }
  ...
  protected void process() {
    super.process();
    processedView(wrapper);

    VLViewComponentXML tabpaneConfig = viewContext.getViewConfig().getRootComponent().getComponentById("TabPane").orElse(null);
    QuaternaryMenuTabPane tabPane = new QuaternaryMenuTabPane(tabpaneConfig, this);
