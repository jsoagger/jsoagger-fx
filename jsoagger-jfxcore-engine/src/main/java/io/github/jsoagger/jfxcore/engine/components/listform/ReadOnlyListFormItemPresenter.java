 ...
 * @date 2019
 */
public class ReadOnlyListFormItemPresenter extends PreferenceItemPresenterFactory implements IListFormCellPresenter {

  private String key;
  private String context;
  private final Label valueLabel = new Label();
  private IListFormDataLoader valueLoader;


  public ReadOnlyListFormItemPresenter() {
    valueLabel.getStyleClass().add("item-presenter-value-label");
  }


  @Override
  public void setDataLoader(IListFormDataLoader loader) {
