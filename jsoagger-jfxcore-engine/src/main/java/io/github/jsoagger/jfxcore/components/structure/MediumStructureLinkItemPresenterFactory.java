 ...
 * @date 2019
 */
public class MediumStructureLinkItemPresenterFactory extends MultiPresenterFactory implements IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public MediumStructureLinkItemPresenterFactory() {
    URL location = MediumStructureLinkItemPresenterFactory.class.getResource("MediumStructureLinkItemPresenterFactory.fxml");
