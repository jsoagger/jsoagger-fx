...
public class InputComponentWrapper extends StackPane implements IInputComponentWrapper, IDisplayable, IMinimizable {
  ...
  private void buildViewComponent() {
    ...
    final String viewUtility = configuration.getPropertyValue(XMLConstants.VIEW_UTILITY, "BasicAttributeInputView");
  ...
  public void validate() {
    if(getDisplay().isVisible() && editInputComponent != null){
