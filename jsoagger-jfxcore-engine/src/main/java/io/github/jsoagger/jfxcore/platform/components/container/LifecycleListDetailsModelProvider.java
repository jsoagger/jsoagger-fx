...
/**
 * Provide model for details view of a lifecycle from a list in a conteext of list details view.
 *
...
public class LifecycleListDetailsModelProvider extends AbstractModelProvider implements IModelProvider {
  ...
  protected IOperation getTypeByOidOperation;// needs GetLifecycleByOidOperation


  /**
   * Default Constructor
   */
  public LifecycleListDetailsModelProvider() {
    super();
  }
