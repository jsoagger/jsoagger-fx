 ...
 * @date 2019
 */
public class DeleteLinksBetweenTwoObjectsButtonAccessRuleResolver extends AbstractRuleResolver implements IAccessRuleResolver {
  ...
  public UIAccessRule isAccessible(IJSoaggerController controller, VLViewComponentXML compConfig) {
    ...
    OperationData operationDataRoleA = ((AbstractViewController) controller).getStructureContent().getFormModelData();
