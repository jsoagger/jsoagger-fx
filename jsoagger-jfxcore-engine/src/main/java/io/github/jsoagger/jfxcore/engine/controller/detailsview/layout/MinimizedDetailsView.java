...
import io.github.jsoagger.jfxcore.engine.components.presenter.impl.ModelIconProvider;
 ...
 * @date 16 févr. 2018
 */
public class MinimizedDetailsView extends DetailsView implements IMinimizedDetailsView, IToolbarHolder {
   ...
   * Default Constructor
   */
  public MinimizedDetailsView() {
    super();
    URL url = MinimizedDetailsView.class.getResource("MinimizedDetailsView.fxml");
  ...
  public void buildFrom(IJSoaggerController controller, VLViewComponentXML configuration) {
    ...
    NodeHelper.styleClassSetAll(this, configuration, "styleClass", "ep-minimized-details-view-root-pane");
