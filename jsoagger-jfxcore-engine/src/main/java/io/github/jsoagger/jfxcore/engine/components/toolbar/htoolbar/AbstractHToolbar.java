...
public abstract class AbstractHToolbar extends AbstractToolbar {
  ...
  private void buildRootActionsToolbar() {
    if (rootMenuconfiguration != null) {
      ...
      VLViewComponentXML leftActions =
          rootMenuconfiguration.getComponentById("LeftActions").orElse(null);
      if (leftActions != null) {
      ...
      VLViewComponentXML centerActions =
          rootMenuconfiguration.getComponentById("CenterActions").orElse(null);
      ...
      VLViewComponentXML rightActions =
          rootMenuconfiguration.getComponentById("RightActions").orElse(null);
      ...
      System.out.println(">>>>>>>>>> 4444444: rootMenuconfiguration is null");
    }
    ...
    if (!centerSection.getChildren().isEmpty()) {
      if (!addedLeft && !AbstractApplicationRunner.isMobile()
          && !AbstractApplicationRunner.isSimulMobile()) {
        allOverWrapper.getChildren().addAll(NodeHelper.horizontalSpacer());
      }
