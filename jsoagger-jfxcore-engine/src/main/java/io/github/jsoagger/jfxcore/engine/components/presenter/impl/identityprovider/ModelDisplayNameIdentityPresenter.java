 ...
 * @date 30 janv. 2018
 */
public class ModelDisplayNameIdentityPresenter extends AbstractModelPresenter implements ModelIdentityPresenter {

  /**
   * Default Constructor
   */
  public ModelDisplayNameIdentityPresenter() {
    super();
  }
  ...
  public String identityOf(IJSoaggerController controller, VLViewComponentXML component) {
    return getModelAttribute(controller, "attributes.displayName");
  }
  ...
  public String identityOf(IJSoaggerController controller, VLViewComponentXML configuration, Object forModel) {
    return getModelAttribute((OperationData) forModel, "attributes.displayName");
  }
