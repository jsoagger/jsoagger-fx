 ...
 * <p>
 * If the action is success, forward model to given view. The current view will be replaced by new
 * generated view in list of visited view. This means that if the user clicks to back action, the
 * view displayed is the view before the current view..
 * <p>
 *
 * @author Ramilafananana  VONJISOA
 *
 */
public class ModelByOidDoActionAndReplaceByViewHandler extends AbstractAction implements IAction {
   ...
   * Default Constructor
   */
  public ModelByOidDoActionAndReplaceByViewHandler() {
    super();
  }
  ...
  public void replaceViewAction(OperationData operationData) {
    PushStructureContentEvent ev = new PushStructureContentEvent.Builder().viewId(viewId).modelFullId((String) operationData.getAttributes().get("fullId")).model(operationData).build();
