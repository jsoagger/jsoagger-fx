 ...
 * @date 2019
 */
public class ContentItemHFlowItemPresenterFactory extends MultiPresenterFactory implements IIDentifiable, IBuildable, IMinimizable {
   ...
   * Constructor
   */
  public ContentItemHFlowItemPresenterFactory() {
    NodeHelper.loadFXML(getLocation(), this);
  }


  protected URL getLocation() {
    return ContentItemHFlowItemPresenterFactory.class.getResource("ContentItemHFlowItem.fxml");
  }
